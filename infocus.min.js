 ...
 *
 */
"use strict";function findLabel(e){var t=null;if(e.hasAttribute("id")&&(t=document.querySelector('label[for="'+e.getAttribute("id")+'"]')),!t)for(t=e;(t=t.parentElement)&&"LABEL"!==t.nodeName;);return t}function infocus(e){function t(t){t.classList.contains(e.focusClass)||t.classList.add(e.focusClass)}function s(t){t.classList.contains(e.focusClass)&&t.classList.remove(e.focusClass)}var n;if("string"==typeof e?e={focusClass:e}:"undefined"==typeof e&&(e={}),e.inputSelector||(e.inputSelector="input, textarea, select"),e.focusClass||(e.focusClass="infocus"),e.storeLabels&&("function"==typeof WeakMap?n=new WeakMap:console.warn("WeakMap not available - not storing associated labels")),e.useDocListener)document.addEventListener("focus",function(s){var a;"function"==typeof s.target.matches&&s.target.matches(e.inputSelector)&&(n&&(a=n.get(s.target))?t(a):(a=findLabel(s.target))&&(t(a),n&&n.set(s.target,a)))},!0),document.addEventListener("blur",function(t){var a;"function"==typeof t.target.matches&&t.target.matches(e.inputSelector)&&(n&&(a=n.get(t.target))?s(a):(a=findLabel(t.target))&&(s(a),n&&n.set(t.target,a)))},!0);else{var a,o,i=document.querySelectorAll(e.inputSelector),c=i.length;for(a=0;c>a;a++)(o=findLabel(i[a]))&&(i[a].addEventListener("focus",t.bind(this,o)),i[a].addEventListener("blur",s.bind(this,o)))}}"undefined"!=typeof module&&(module.exports=infocus);